...
import { formeBoldnessInput, formeCreativityInput, formeExecutionInput, formeHumorInput, formePresentationInput } from "../schemas/admin.schema";
import { db } from "@/db";
import { featureFlags } from "@/db/schema";

export const publicRoutes = new Hono()
    .put('/isFormeBoldness', zValidator('json',formeBoldnessInput), async(c) => {
    ...
    .put('/isFormeExecution', zValidator('json',formeExecutionInput), async(c) => {
    ...
    .put('/isFormeCreativity', zValidator('json',formeCreativityInput), async(c) => {
    ...
    .put('/isFormePresentation', zValidator('json',formePresentationInput), async(c) => {
